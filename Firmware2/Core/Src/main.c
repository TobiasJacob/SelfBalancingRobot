...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DISPLAY_ENABLE_Pin|GYRO_SPI_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : DRV_FG_Pin */
  GPIO_InitStruct.Pin = DRV_FG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(DRV_FG_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : DISPLAY_ENABLE_Pin GYRO_SPI_CS_Pin */
  GPIO_InitStruct.Pin = DISPLAY_ENABLE_Pin|GYRO_SPI_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
